            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="mb-3 flex flex-1 flex-col">
                  ...
                  <input
                    disabled={!data.isActive}
                    className="form-control px-3 py-1.5 text-sm w-56 font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    type="file"
                    name="file"
                    onChange={(event: any) => {
                      // setData((prev) => {
